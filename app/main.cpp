...
static motor_sptr motor_front_right{nullptr}, motor_front_left{nullptr},
    motor_back_right{nullptr}, motor_back_left{nullptr};
...
void motor_init() {
  //モーターの初期化
  motor_manager =
      move(MotorManager::GenerateMotorManeger("/dev/ttyUSB0", 115200));
